...
public:
	 ...
	 *
	 */
	//implementing setter & getter for patient class attributes
	...
	Patient(string aCareCard, string aName, string anEmail);
	
	Patient(string aCareCard, string aName, string anEmail, string aPhone);
	
	Patient(string aCareCard, string aName, string anEmail, string anAddress, string aPhone);
	// Getters and setters
